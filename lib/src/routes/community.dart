    ...
    child: Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 8),
          SvgPicture.asset('assets/homepage/icons/arrow_down.svg',height: 14,width: 16,)
        ],
      ),
    ),
  );
...
// }
  ...
  decoration: BoxDecoration(
    ...
    image: community?.coverImg != null && community!.coverImg!.isNotEmpty
        ? DecorationImage(
            image: CachedNetworkImageProvider(community!.coverImg!),
            fit: BoxFit.cover,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children:[
                                ...
                                Row(
                                  children: [
                                    Text(
                                      (community?.followersCount ?? 0).toString(),
                                      style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w700,
                      ...
                      const Text("Use this forum to Lorem ipsum dolorajhds Read More"),
                      const SizedBox(height: 10),
                      Row(
                        children: [
