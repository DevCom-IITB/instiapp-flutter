            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    AssetImage('assets/explore/symphony.png'),
                                fit: BoxFit.cover)),
                      ),
                      SizedBox(width: 16),
                      Container(
                          ...
                          Container(
                            ...
                            child: Center(
                                child: Container(
                                    ...
                                    width: 2,
                                    child: SvgPicture.asset(
                                        'assets/communities/icons/dots.svg',
                                        fit: BoxFit.contain))),
                          )
                        ],
                      )
                  ...
                  SizedBox(height: 10),
                  Text("Use this forum to Lorem ipsum dolorajhds Read More"),
                  SizedBox(height: 10),
                  Row(
                    children: [
            ...
            Navigator.of(context).pushNamed("/posts/add",
                arguments: NavigateArguments());
                      ...
                      icon: Icon(Icons.add_circle,
                          color: myConstants.instiappBlue, size: 48))
                ],
              ),
            ),
          ],
