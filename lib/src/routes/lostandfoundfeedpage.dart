...
class _LostpageState extends State<LostPage> {
  ...
  Widget build(BuildContext context) {
    ...
    double screen_wr = MediaQuery
        .of(context)
        .size
        .width;
    double screen_hr = MediaQuery
        .of(context)
        .size
        .height;
    double x, y;
            ...
            child: Column(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                      child: Container(
                          child: _buildContent(screen_h, screen_w,
                            myfont, context,)
                      )
                  ),
                ],
  ...
  Widget _buildContent(double screen_h, double screen_w,
      double myfont, BuildContext context,) {
        ...
        child: Card(
          ...
          child: InkWell(
            onTap: () {
              ...
              Navigator.of(context).pushNamed('/lostandfoundinfo');
            },
            child: SizedBox(
                child: Stack(
                  children: [
