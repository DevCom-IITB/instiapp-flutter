...
class _InstiAppApi implements InstiAppApi {
  ...
  Future<List<ResobinCourse>> getResobinSchedule(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<ResobinCourse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'https://resobin.gymkhana.iitb.ac.in/api/todays-schedule/${rollNo}/',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    var value = _result.data!
        .map((dynamic i) => ResobinCourse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<CalendarInfoResponse> getCalendarSharedBySlug(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CalendarInfoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CalendarInfoResponse.fromJson(_result.data!);
    return value;
  }
