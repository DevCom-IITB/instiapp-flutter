                    ...
                    decoration: ShapeDecoration(
                      shape: RoundedRectangleBorder(
                        side: BorderSide(
                          ...
                          color: const Color(0xFFD2D5DA) /* instiappgrey3 */,
                        ),
                        borderRadius:
                            BorderRadius.circular(Responsive.width(185, context)),
                      ),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            height: Responsive.height(1.71, context),
                            letterSpacing: Responsive.width(0.38, context),
                          ),
                        ),
                      ],
                    ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        ...
                        vertical: Responsive.height(10.95, context)),
                    decoration: ShapeDecoration(
                      color: const Color(0xFFEFEFEF),
                      shape: RoundedRectangleBorder(
                        side: BorderSide(
                          width: Responsive.width(1.37, context),
                          color: const Color(0xFFD2D5DA),
                        ),
                        borderRadius: BorderRadius.circular(
                            Responsive.width(68.42, context)),
                      ),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
