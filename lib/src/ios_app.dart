...
class MyIOSApp extends StatefulWidget {
  ...
  MyIOSApp({this.key, @required this.bloc}) : super(key: key);

  @override
  MyIOSAppState createState() => MyIOSAppState();
}

class MyIOSAppState extends State<MyIOSApp> with WidgetsBindingObserver {
